...
_Generated: 2026-08-14T08:10:15.293Z_
...
Workspace `mcp.json` _(folder: PROJECT-SHOWCASE-APP)_

- **\\wsl.localhost\Ubuntu\home\beatrice\PROJECT-SHOWCASE-APP\.vscode\mcp.json** — _File missing_
